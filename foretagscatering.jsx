...
const Foretagscatering = ({ onNavigate }) => {
      ...
      <section style={{ padding: 'var(--space-2xl) 0 var(--space-xl)', background: 'var(--color-dark)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative' }}>
          <Reveal>
            ...
            <span className="badge" style={{ background: 'rgba(26,140,126,0.9)', color: 'white', display: 'block', width: 'fit-content', marginBottom: '0.75rem' }}>Företagscatering</span>
            <h1 style={{ fontSize: 'clamp(2.25rem, 5vw, 3.5rem)', color: 'var(--color-cream)', maxWidth: 650 }}>
              Professionell catering<br/><span style={{ color: 'var(--color-saffron-light)', fontStyle: 'italic' }}>för ert kontor</span>
            </h1>
            <p style={{ color: 'rgba(251,247,241,0.65)', maxWidth: 520, marginTop: 'var(--space-sm)', fontSize: '1rem', lineHeight: 1.7 }}>
              Avsmakningsmenyer för 6 till 300 personer. Vi hjälper gärna till med maten!
            </p>
          </Reveal>
        </div>
      </section>
            ...
            {!submitted ? (
              <div style={{
                ...
                border: '1px solid var(--color-border-light)',
                  ...
                  <ForetagForm onSuccess={() => setSubmitted(true)} preSelected={selectedMenu} />
              </div>
            ) : (
              <div style={{
                ...
                <p style={{ color: 'var(--color-text-light)', maxWidth: 400, margin: '0 auto' }}>Vi återkommer med bekräftelse till din e-post.</p>
...
window.Foretagscatering = Foretagscatering;
